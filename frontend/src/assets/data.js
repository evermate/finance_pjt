export default {
  mapInfo: [
    ...
    },
    {
      ...
      countries: [
        ...
        "성남시 분당구", "성남시 수정구", "성남시 중원구", "수원시 권선구", "수원시 영통구", "수원시 장안구", "수원시 팔달구",
        "시흥시", "안산시 단원구", "안산시 상록구", "안성시", "안양시 동안구", "안양시 만안구", "양주시",
        "양평군", "여주군", "연천군", "오산시", "용인시 기흥구", "용인시 수지구", "용인시 처인구",
    ...
    },
    {
      ...
      countries: [
        ...
        "아산시", "연기군", "예산군", "천안시 동남구", "천안시 서북구", "청양군", "태안군", "홍성군"
      ]
    },
    {
      name: "전라북도",
  ...
  bankInfo: [
    "국민은행", "신한은행", "우리은행", "하나은행", "산업은행", "농협", "새마을금고", "신협",
    "우체국", "기업은행", "부산은행", "대구은행", "광주은행", "경남은행", "전북은행", "제주은행", "수협"
  ]
}
