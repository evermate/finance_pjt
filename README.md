...
사용자의 나이와 자산 수준을 바탕으로 다음과 같은 전략으로 금융 상품을 추천합니다:

- **젊고 자산이 많은 사용자**: 장기 투자에 적합한 고수익 상품 위주로 추천  
- **젊고 자산이 적은 사용자**: 단기 유동성이 높은 상품 우선 추천  
- **40세 이상 사용자**: 안정성과 신뢰도를 중시한 주요 시중은행 상품 위주 추천  

이러한 기준에 따라 1차 필터링이 수행된 후, 사용자가 **AI 추천** 기능을 실행하면 OpenAI API를 통해 보다 개인화된 추천이 진행됩니다.  
이때 사용자의 연령, 자산, 투자 성향 등을 프롬프트에 포함하여 ChatGPT가 분석하며, 필터링된 후보군 중에서 최적의 금융상품 3개를 선정하고, 각 상품에 대해 사용자 맞춤형 설명을 제공합니다.  
